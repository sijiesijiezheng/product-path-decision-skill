...
Whether a decision layer is necessary

Whether the skill can correctly classify different input types

Whether the clarification mechanism is stable across similar cases
